...
.. prompt:: bash
    ...
    ./docker-compose-run alembic --config c2cgeoportal/tests/functional/alembic.ini --name=main upgrade head
    ./docker-compose-run alembic --config c2cgeoportal/tests/functional/alembic.ini --name=static upgrade head
