...
.. note::
   ...
   In the user vars of children projects, the ``parent_instanceid`` should be
   defined so that it works in the user dev environment.
...
The goal is to be able to crate a custom makefile with witch one we make:
