...
App.Locator = function(map, actionOptions) {
    ...
    var template = new Ext.XTemplate(
        '<p>' + OpenLayers.i18n('Locator.easting') +
            '&nbsp;{[values.measure.x.toFixed(this.decimals)]} {units}</p>',
        '<p>' + OpenLayers.i18n('Locator.northing') +
            '&nbsp;{[values.measure.y.toFixed(this.decimals)]} {units}</p>',
        {
            compiled: true,
