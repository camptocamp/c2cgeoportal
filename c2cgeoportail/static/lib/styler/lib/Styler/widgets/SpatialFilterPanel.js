...
Styler.SpatialFilterPanel = Ext.extend(Styler.BaseFilterPanel, {
    ...
    initComponent: function() {
        ...
        switch (this.feature.geometry.CLASS_NAME) {
            ...
            /*
            // contains does not work with this version of MapServer (5.6.5)
        ...
        var defComboConfig = {
            ...
            blankText: OpenLayers.i18n("required field"),
            listeners: {
