...
class MapperServer {
    ...
    static async create(cdpUrl, mapperContent) {
        ...
        try {
            const mapperCdpClient = await this.initMapper(cdpConnection, mapperContent);
    ...
    static async establishCdpConnection(cdpUrl) {
