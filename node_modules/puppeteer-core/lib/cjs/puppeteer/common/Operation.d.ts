 ...
 * @internal
 */
export declare class Operation<T> extends Promise<T> {
    #private;
    /**
     * @internal
     */
    static create<T>(fn: () => Awaitable<T>, delay?: number): Operation<T>;
    /**
    ...
    then<TResult1 = T, TResult2 = never>(onfulfilled?: (value: T) => TResult1 | PromiseLike<TResult1>, onrejected?: (reason: any) => TResult2 | PromiseLike<TResult2>): Operation<TResult1 | TResult2>;
}
